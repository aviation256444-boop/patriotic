...
const quickLinks = [
  ...
  { href: "/super-admin/verify", label: "Verify membership", desc: "Check digital membership cards", icon: Users },
  { href: "/super-admin/events", label: "Events", desc: "Price, capacity, seats", icon: Calendar },
  { href: "/super-admin/payments", label: "Event payments", desc: "Revenue & e-tickets", icon: BarChart3 },
