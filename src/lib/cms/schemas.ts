...
export const siteSettingsFields: FieldDef[] = [
  ...
  { key: "heroSubheadline", label: "Hero Subheadline", type: "textarea", rows: 3 },
  {
    ...
    type: "image",
    help: "Upload your logo — it appears in the header, footer, and auth pages site-wide.",
  },
  {
    key: "heroImage",
    label: "Homepage Hero Image",
    type: "image",
    help: "Upload a photo for the homepage hero. No external link required.",
  },
  {
    key: "ogImage",
    label: "Social Share Image",
    type: "image",
    help: "Optional image for social media previews.",
  },
