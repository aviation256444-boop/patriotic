...
export const collectionSchemas: CollectionSchema[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "district", label: "District", type: "text" },
      {
        ...
        type: "number",
        help: "Exact map pin. If empty, district name is used to place the pin.",
      },
      {
        key: "lng",
        label: "Longitude (optional)",
        type: "number",
        help: "Exact map pin longitude.",
      },
  ...
  },
  {
    ...
    defaults: {
      ...
      registered: 0,
      tags: [],
      organizer: "PYU Secretariat",
    },
    fields: [
      { key: "title", label: "Title", type: "text", required: true },
      { key: "slug", label: "URL Slug", type: "text", required: true, help: "Used in the public URL: /events/your-slug" },
      { key: "description", label: "Description", type: "textarea", required: true, rows: 4 },
      {
        key: "type",
        label: "Type",
      ...
      { key: "district", label: "District", type: "text" },
      {
        ...
        label: "Latitude (optional)",
        type: "number",
        help: "Exact venue pin for the map. If empty, district name is geocoded from our Uganda list.",
      },
      {
        key: "lng",
        label: "Longitude (optional)",
      ...
      { key: "capacity", label: "Capacity (seats)", type: "number", help: "Total seats available for booking." },
      { key: "registered", label: "Already registered (seed)", type: "number", help: "Starting count — increases when tickets are issued." },
      {
        key: "price",
        label: "Price per seat (UGX)",
        type: "number",
        help: "Set above 0 for paid tickets (Airtel / MTN / card). Leave 0 for free entry. Minimum live MoMo charge is usually 500 UGX.",
      },
      {
        key: "isFree",
        label: "Free Event (no payment)",
        type: "checkbox",
        help: "Auto-unchecked when you enter a price. Paid events show Airtel Money, MTN MoMo, and card checkout.",
      },
